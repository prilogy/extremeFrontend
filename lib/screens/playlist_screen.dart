                ...
                model.isPaid == true
                    ? BlockBaseWidget(
                        child: IsSalablePayCard(
                          ...
                          onBuySuccess: () async {
                            var playlist =
                                await Api.Entities.getById<Models.Playlist>(
                                    model.id);
                  ...
                  child: CustomFutureBuilder<List<Models.Video>?>(
                      ...
                      builder: (data) => CustomListBuilder(
                          ...
                          itemBuilder: (item) => VideoCard(
                              aspectRatio: 16 / 9, model: item as Video))),
                ),
...
class HeaderPlaylist extends StatelessWidget {
  ...
  HeaderPlaylist({required this.model});

  @override
  Widget build(BuildContext context) {
    var theme = Theme.of(context);
    final description = model.content?.description ?? '';
